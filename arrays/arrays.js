// let autos = ['Fiat', 'Ford', 'Torino', 'Chevy'];
// console.log(autos);


// let bandas = new Array(7)
// console.log(bandas);

// let multiples_datos = [1978, 'Capitán', true, {nombre: 'Luciano', apellido: 'Latella'}];
// console.log(multiples_datos)


let autos = new Array('Fiat', 'Ford', 'Torino', 'Chevy');
// console.log(autos);
...
autos.forEach(function(auto, indice){
    console.log(`el auto ${auto} está ubicado en la posicion ${indice}`);
     })

    //  DE GITHUB DE LA CLASE:
